...
static const uint64_t SWITCH_BUTTONS_FULL_MAPPING[_BUTTON_MAX] = {
    ...
    // TwiNX controller convention:
    // - D-pad and left stick move UI focus.
    // - Right stick is reserved for independent page scrolling.
    HidNpadButton_Up | HidNpadButton_StickLUp, // BUTTON_NAV_UP
    HidNpadButton_Right | HidNpadButton_StickLRight, // BUTTON_NAV_RIGHT
    HidNpadButton_Down | HidNpadButton_StickLDown, // BUTTON_NAV_DOWN
    HidNpadButton_Left | HidNpadButton_StickLLeft, // BUTTON_NAV_LEFT
};
